...
{
    public class SvcUsuarioPerfilApi : ISvcUsuarioPerfil
    {
        private SeguridadLogic.UsuarioPerfilLogic usuarioperfil;
        public SvcUsuarioPerfilApi()
        {
        ...
        {
            return await usuarioperfil.ObtenerAreaCargoPorEmpleadoPerfilAsync(DatosGlobales.GestorApi, IdEmpleadoPerfil);
        }
    }
}
