...
{
    //[ValidarUsuario]
    public class CatalogoCasillaController : Controller
    {
        private ListaCatalogo listacatalogo;
        private readonly ISvcCatalogo icatalogo;

        public CatalogoCasillaController(ISvcCatalogo _icatalogo)
        {
            icatalogo = _icatalogo;
            listacatalogo = new ListaCatalogo();
        }
        [HttpGet]
        public IActionResult IndexCatalogoCasilla()
        {
        ...
        public async Task<IActionResult> ListarCatalogoPadre(IDataTablesRequest requestModel)
        {
            ...
            try
            {
                listacatalogo = await icatalogo.ListarCatalogoPadreAsync(Convert.ToInt32(HttpContext.Session.GetString("IdUsuario") == null ? 0 : HttpContext.Session.GetString("IdUsuario")), null, null, numeroPagina, requestModel.Length, requestModel.Search.Value, "Casilla");
        ...
        public async Task<IActionResult> ListarCatalogo(IDataTablesRequest requestModel)
        {
            ...
            try
            {
                listacatalogo = await icatalogo.ListarCatalogoAsync(Convert.ToInt32(HttpContext.Session.GetString("IdUsuario") == null ? 0 : HttpContext.Session.GetString("IdUsuario")), IdCatalogoPadre, null, null, numeroPagina, requestModel.Length, requestModel.Search.Value, "Casilla");
                if (listacatalogo.mensaje.CodigoMensaje > 0)
                {
                    return RedirectToAction("PaginaError", new { DescripcionError = listacatalogo.mensaje.DescripcionMensaje });
                }
        ...
        public async Task<IActionResult> RegistroCatalogo()
        {
            ...
            try
            {
                if (IdCatalogo > 0)
                {
                    catalogo = await icatalogo.ObtenerCatalogoAsync(IdCatalogo, Convert.ToInt32(HttpContext.Session.GetString("IdUsuario") == null ? 0 : HttpContext.Session.GetString("IdUsuario")), "Casilla");
                }
        ...
        public async Task<IActionResult> GuardarRegistroCatalogo()
        {
            ...
            try
            {
                ...
                Detalle,
                Activo,
                Convert.ToInt32(HttpContext.Session.GetString("IdUsuario") == null ? 0 : HttpContext.Session.GetString("IdUsuario")), "Casilla");
        ...
        public async Task<IActionResult> EliminarCatalogo()
        {
            ...
            try
            {
                mensaje = await icatalogo.EliminarCatalogoAsync(IdCatalogo, Convert.ToInt32(HttpContext.Session.GetString("IdUsuario") == null ? 0 : HttpContext.Session.GetString("IdUsuario")), "Casilla");
                return Json(mensaje);
            }
            catch (Exception ex)
            {
        ...
        {
            listacatalogo = await icatalogo.ListarCatalogoComboAsync(1, "Casilla");
            var data = listacatalogo.lista.Select(lq => new
            {
                lq.IdCatalogo,
                lq.Descripcion
        ...
        {
            listacatalogo = await icatalogo.ListarCatalogoComboAsync(8, "Casilla");
            var data = listacatalogo.lista.Select(lq => new
            {
                lq.IdCatalogo,
                lq.Descripcion
        ...
        {
            listacatalogo = await icatalogo.ListarCatalogoComboAsync(15, "Casilla");
            var data = listacatalogo.lista.Select(lq => new
            {
                lq.IdCatalogo,
                lq.Descripcion
        ...
        {
            listacatalogo = await icatalogo.ListarCatalogoComboAsync(24, "Casilla");
            var data = listacatalogo.lista.Select(lq => new
            {
                lq.IdCatalogo,
                lq.Descripcion
        ...
        {
            listacatalogo = await icatalogo.ListarCatalogoComboAsync(11, "Casilla");
            var data = listacatalogo.lista.Select(lq => new
            {
                lq.IdCatalogo,
                lq.Descripcion
        ...
        {
            listacatalogo = await icatalogo.ListarCatalogoComboAsync(31, "Casilla");
            var data = listacatalogo.lista.Select(lq => new
            {
                lq.IdCatalogo,
                lq.Descripcion
        ...
        public async Task<IActionResult> ListarCatalogoTipoUso()
        {
            ...
            listacatalogo = await icatalogo.ListarCatalogoComboAsync(33, "Casilla");
            var data = listacatalogo.lista.Select(lq => new
            {
                lq.IdCatalogo,
                lq.Descripcion
        ...
        {
            var listacatalogo = await icatalogo.ListarCatalogoComboAsync(36, "Casilla");
            var data = listacatalogo.lista.Select(lq => new
            {
                lq.IdCatalogo,
                lq.Descripcion
        ...
        {
            var listacatalogo = await icatalogo.ListarCatalogoComboAsync(39, "Casilla");
            var data = listacatalogo.lista.Select(lq => new
            {
                lq.IdCatalogo,
                lq.Descripcion
        ...
        [HttpPost]
        public async Task<IActionResult> ListarCatalogoCategoria()
        {
            var listacatalogo = await icatalogo.ListarCatalogoComboAsync(1, "Casilla");
            var data = listacatalogo.lista.Select(lq => new
            {
                lq.IdCatalogo,
                lq.Descripcion
        ...
        [HttpPost]
        public async Task<IActionResult> ListarCatalogoTipoDocumento()
        {
            var listacatalogo = await icatalogo.ListarCatalogoComboAsync(5, "Casilla");
            var data = listacatalogo.lista.Select(lq => new
            {
                lq.IdCatalogo,
                lq.Descripcion
